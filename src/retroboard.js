  ...
  return (
    <div className="min-h-screen bg-[#121212] text-[#E0E0E0] p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <button
            ...
            onClick={() => {
              ...
              if (comment) {
                ...
                document.getElementById('goWellComment').value = ''; // Clear input after adding
              }
            }}
          >
            Add
          ...
          <button
            ...
            onClick={() => {
              ...
              if (comment) {
                ...
                document.getElementById('didntGoWellComment').value = ''; // Clear input after adding
              }
            }}
          >
            Add
        ...
        {/* Areas for improvement - Electric Blue */}
        <div className="bg-[#1C1C1C] shadow-md rounded-lg p-4">
          ...
          <button
            ...
            onClick={() => {
              ...
              if (comment) {
                ...
                document.getElementById('areasForImprovementComment').value = ''; // Clear input after adding
              }
            }}
          >
            Add
        ...
        {/* Actions Section - Electric Purple */}
        <div className="bg-[#1C1C1C] shadow-md rounded-lg p-4">
          ...
          <button
            ...
            onClick={() => {
              ...
              if (comment) {
                ...
                document.getElementById('actionsComment').value = ''; // Clear input after adding
              }
            }}
          >
            Add
